...
<div class="page-header">
    ...
    <a href="{{ route('reservaciones.calendar') }}" class="btn btn-sm btn-outline-danger">
        📅 Ver calendario
    </a>
</div>
    ...
    <table class="table table-hover">
        ...
        @forelse($reservations as $r)
            <tr>
                ...
                <td class="text-end">
                    <a href="{{ route('reservaciones.edit', $r->id) }}" class="btn btn-sm btn-outline-secondary">Editar</a>

                    <form action="{{ route('reservaciones.destroy', $r->id) }}" method="POST" class="d-inline" onsubmit="return confirm('¿Eliminar reserva?')">
                        @csrf
                        @method('DELETE')
