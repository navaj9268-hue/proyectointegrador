...
<div class="home-container">
  ...
  <div class="hero">
    ...
    <div class="hero-actions">
      <a href="{{ route('rooms.create') }}" class="btn btn-sm" style="background:linear-gradient(90deg,#b23a3a,#ff6b6b); color:#fff; border:none;">➕ Crear habitación</a>
      <a href="{{ route('inventories.index') }}" class="btn btn-sm btn-outline-secondary">📦 Inventario</a>

      {{-- Botones de reportes PDF integrados --}}
      <div class="btn-group ms-2" role="group" aria-label="Reportes">
        <a href="{{ route('reports.rooms') }}" class="btn btn-sm btn-outline-secondary" title="PDF Habitaciones">📄 Habitaciones</a>
        <a href="{{ route('reports.inventories') }}" class="btn btn-sm btn-outline-secondary" title="PDF Inventario">📄 Inventario</a>
        <a href="{{ route('reports.users') }}" class="btn btn-sm btn-outline-secondary" title="PDF Usuarios">📄 Usuarios</a>
        <a href="{{ route('reports.general') }}" class="btn btn-sm" style="background:linear-gradient(90deg,#b23a3a,#ff6b6b); color:#fff;" title="Reporte general">📊 General</a>
      </div>
    </div>
  </div>
  ...
  <div class="grid">
    ...
    <div>
      <div class="hotel-card">
        ...
        <div style="display:flex; gap:8px;">
          ...
          <a href="{{ route('users.index') }}" class="btn btn-sm" style="background:linear-gradient(90deg,#b23a3a,#ff6b6b); color:#fff; border:none;">👥 Usuarios</a>
        </div>
    ...
    <div>
      <div class="quick-grid">
        <a href="{{ route('rooms.index') }}" class="quick text-decoration-none">
        ...
        <a href="{{ route('inventories.index') }}" class="quick text-decoration-none">
          <div class="icon">📦</div>
          <div>
        ...
        <a href="{{ route('users.index') }}" class="quick text-decoration-none">
          <div class="icon">👥</div>
          <div>
        ...
        <a href="{{ route('rooms.create') }}" class="quick text-decoration-none">
          <div class="icon">➕</div>
          <div>
