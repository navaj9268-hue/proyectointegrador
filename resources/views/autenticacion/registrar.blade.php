    ...
    <div class="form-panel" id="formPanel">
      ...
      <form method="POST" action="{{ url('register') }}" id="registerForm" novalidate>
        ...
        <div class="mb-3 form-check">
          ...
          <label class="form-check-label" for="terms">Acepto los <a href="{{ route('terminos-y-condiciones') }}" target="_blank">términos y condiciones</a>.</label>
        </div>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    // Si viene de aceptar términos, marcar la casilla automáticamente
