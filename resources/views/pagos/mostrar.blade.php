...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <div>
    <a href="{{ route('pagos.edit', $payment) }}" class="btn btn-sm btn-outline-primary">Editar</a>
    <a href="{{ route('pagos.index') }}" class="btn btn-sm btn-outline-secondary">Volver</a>
  </div>
</div>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      @if($payment->reservation)
        <p>
          <a href="{{ route('reservaciones.mostrar', $payment->reservation) }}">
