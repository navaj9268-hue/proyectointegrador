...
<div class="page-header mb-3">
  ...
  <div class="d-flex gap-2 align-items-center">
    ...
    <a href="{{ route('rooms.create') }}" class="btn btn-sm btn-primary d-none d-md-inline-flex" title="Crear habitación" style="background: linear-gradient(90deg,#b23a3a,#ff6b6b); border:none;">
      ➕ Nueva habitación
    </a>
  </div>
</div>
  ...
  <tbody>
    @forelse($rooms as $room)
      <tr>
        ...
        <td class="text-end">
          <a href="{{ route('rooms.edit', $room) }}" class="btn btn-sm btn-outline-red me-1">Editar</a>

          <form action="{{ route('rooms.destroy', $room) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Eliminar habitación?')">
            @csrf
            @method('DELETE')
      ...
      <tr>
        <td colspan="7">
          <div class="empty-state">
            ...
            <a href="{{ route('rooms.create') }}" class="btn btn-sm" style="background: linear-gradient(90deg,#b23a3a,#ff6b6b); color:#fff;">➕ Crear habitación</a>
          </div>
        </td>
      </tr>
    @endforelse
    ...
    <div class="room-card">
      <div class="d-flex justify-content-between align-items-start">
        ...
        <div class="d-flex flex-column align-items-end gap-2">
          <a href="{{ route('rooms.edit', $room) }}" class="btn btn-sm btn-outline-red">Editar</a>
          <form action="{{ route('rooms.destroy', $room) }}" method="POST" onsubmit="return confirm('Eliminar habitación?')">
            @csrf
            @method('DELETE')
            <button class="btn btn-sm btn-danger">Eliminar</button>
          </form>
